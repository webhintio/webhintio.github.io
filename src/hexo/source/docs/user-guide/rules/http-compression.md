---
category: "user-guide"
description: "http-compression warns against not serving resources compressed whenrequested as such using the most appropriate encoding."
layout: "docs"
permalink: "docs/user-guide/rules/http-compression/index.html"
