...
(function () {
    ...
    var childHintsExpanded = function (element) {
    ...
    var updateExpandAllButton = function (element, closeAll) {
        var expanded = typeof closecloseAll !== 'undefined' ? closeAll : childHintsExpanded(element);
    ...
    var toggleExpandHint = function (element, closeAll) {
    ...
    var toggleExpandAll = function (element) {
        ...
        for (var i = 0; i < detailButtons.length; i++) {
            if (expanded) {
                toggleExpandHint(detailButtons[i], true);
            } else {
                toggleExpandHint(detailButtons[i], false);
            }
        }
